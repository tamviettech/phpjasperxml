...
//                $arrdata[$num]=str_replace('"',"",$out);
    ...
    /**
     * Set report arraysqltable data from XML string
     * @param String $xmlString 
     */
    public function transferXMLStringtoArray($xmlString)
    {
        if ($dom_data = simplexml_load_string($xmlString))
        {
            $arr_all_row = $dom_data->xpath(trim($this->sql));
            $i=0;
            foreach ($arr_all_row as $obj)
    ...
    /**
     * Set report arraysqltable data from a 2dims array
     * @param array $arr_data
     */
    public function Set_arraysqltable($arr_data)
    {
        $this->arraysqltable = $arr_data;
    }
